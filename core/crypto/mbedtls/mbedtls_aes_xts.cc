...
mbedtls_aes_xts::mbedtls_aes_xts() { }
mbedtls_aes_xts::~mbedtls_aes_xts() { }
...
int mbedtls_aes_xts::encrypt_128(const crypto_symmetric_key &key_in,
                             const uint8_t *msg_in,
                             uint32_t msg_len_in,
                             crypto_iv &iv_out,
                             uint8_t *msg_out)
...
int mbedtls_aes_xts::encrypt_256(const crypto_symmetric_key &key_in,
                                 const uint8_t *msg_in,
                                 uint32_t msg_len_in,
                                 crypto_iv &iv_out,
                                 uint8_t *msg_out)
...
int mbedtls_aes_xts::decrypt_128(const crypto_symmetric_key &key_in,
                                 const uint8_t *enc_in,
                                 uint32_t enc_len_in,
                                 const crypto_iv &iv_in,
                                 uint8_t *msg_out)
...
int mbedtls_aes_xts::decrypt_256(const crypto_symmetric_key &key_in,
                                 const uint8_t *enc_in,
                                 uint32_t enc_len_in,
                                 const crypto_iv &iv_in,
                                 uint8_t *msg_out)
